...
namespace delivery_
{
    ...
    {
        int orderID;
        int orderStatus;//nemkell
        string orderTime; //nemkell
        string endorderTime;//nemkell
        string approxDeliveryTime;//nemkell
        //string customer;
        ...
        public void setFoods()
        {
            ...
            for (int i = 0; i < foodNums.Length; ++i)
            {
                ...
                */
                ...
                Food food = serverConnection.getFoodByID(foodID);
